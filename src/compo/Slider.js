...
const Slider = () => {
  ...
  return (
    <Container>
        ...
        <Image src='https://finalappchinchorro0029dd132ee54bd4b414de81bee3b82034-dev.s3.amazonaws.com/public/images/app-store-beers+2.png' onClick={()=> history('/portafolio')} alt='pict' />
